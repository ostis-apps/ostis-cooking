...
{ \
	...
	question_check_cyclic_graph = ctx.HelperResolveSystemIdtf("question_check_cyclic_graph", ScType::Node); result = result && question_check_cyclic_graph.IsValid(); \
	question_find_tree_search = ctx.HelperResolveSystemIdtf("question_find_tree_search", ScType::Node); result = result && question_find_tree_search.IsValid(); \
    return result; \
}
